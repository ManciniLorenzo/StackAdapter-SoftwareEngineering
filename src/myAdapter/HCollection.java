...
// http://geas.dei.unipd.it/jdk1.4.2/docs/api/java/util/Collection.html
 ...
 * <p>
 * 
 * All general-purpose HCollection implementation classes (which typically implement HCollection indirectly through one of its subinterfaces) should provide two "standard" constructors: 
 ...
 * There is no way to enforce this convention (as interfaces cannot contain constructors) but all of the general-purpose HCollection implementations in the Java platform libraries comply.
 * <p>
 * 
 ...
 * For example, invoking the addAll(HCollection) method on an unmodifiable collection may, but is not required to, throw the exception if the collection to be added is empty.
 * <p>
 * 
...
public interface HCollection {
	 ...
	 * <p>
	 * 
	 * Suppose l is a HList known to contain only strings. The following code can be used to dump the list into a newly allocated array of String:
	 * <pre>
	 ...
	 * HCollection classes should clearly specify in their documentation any restrictions on what elements may be added.
	 * <p>
	 * 
	 ...
	 * <p>
	 * 
	 * While the HCollection interface adds no stipulations to the general contract for the Object.equals, programmers who implement the HCollection interface "directly" 
	 * (in other words, create a class that is a HCollection but is not a Set or a HList) must exercise care if they choose to override the Object.equals. 
	 ...
	 * (The HList and Set interfaces mandate such value comparisons.)
	 * <p>
	 * 
	 ...
	 * The contracts for HList.equals and Set.equals state that lists are only equal to other lists, and sets to other sets. 
	 * Thus, a custom equals method for a collection class that implements neither the HList nor Set interface must return false when this collection is compared to any list or set. 
	 * (By the same logic, it is not possible to write a class that correctly implements both the Set and HList interfaces.)
	 ...
	 * While the HCollection interface adds no stipulations to the general contract for the Object.hashCode method, programmers should take note that any class that overrides the Object.equals method must also override the Object.hashCode method in order to satisfy the general contract for the Object.hashCodemethod. 
